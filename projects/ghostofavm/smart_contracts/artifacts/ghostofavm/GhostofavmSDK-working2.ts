...
class GhostBase {
  ...
  protected async cacheSuggestedParams() {
  ...
  protected async execute<T>({
    ...
    performance.mark('exec_entry')

    const suggestedParams = await this.cacheSuggestedParams()
    const methodName = signature.slice(0, signature.indexOf('('))

    performance.mark('exec_build')
    ...
    performance.mark('exec_sim_start')
    ...
    const measurements = [
      performance.measure('Total execution', 'exec_entry', 'parse_end'),
      performance.measure('Build time', 'exec_entry', 'exec_build'),
      performance.measure('Simulation preparation', 'exec_build', 'exec_sim_start'),
      performance.measure('Simulation execution', 'exec_sim_start', 'exec_sim_end'),
      performance.measure('Parse results', 'exec_sim_end', 'parse_end'),
    ]
...
export class GhostofavmSDK extends GhostBase {
  ...
  async blkTimestamp(
    ...
    await this.cacheSuggestedParams()
    return this.execute({
      transactions: (
        await Promise.all(
          (Array.isArray(argsOrArgsArray) ? argsOrArgsArray : [argsOrArgsArray]).map((args) =>
            this.factory.createTransaction.create.blkTimestamp({
              args,
              ...extraMethodCallArgs,
            }),
          ),
  ...
  async blkTxnCounter(
    ...
    return this.execute({
      transactions: (
        await Promise.all(
          (Array.isArray(argsOrArgsArray) ? argsOrArgsArray : [argsOrArgsArray]).map((args) =>
            this.factory.createTransaction.create.blkTxnCounter({
              args,
              ...extraMethodCallArgs,
            }),
          ),
  ...
  async blkProposer(
    ...
    return this.execute({
      transactions: (
        await Promise.all(
          (Array.isArray(argsOrArgsArray) ? argsOrArgsArray : [argsOrArgsArray]).map((args) =>
            this.factory.createTransaction.create.blkProposer({
              args,
              ...extraMethodCallArgs,
            }),
          ),
  ...
  async blkData(
    ...
    return this.execute({
      transactions: (
        await Promise.all(
          (Array.isArray(argsOrArgsArray) ? argsOrArgsArray : [argsOrArgsArray]).map((args) =>
            this.factory.createTransaction.create.blkData({
              args,
              ...extraMethodCallArgs,
            }),
          ),
